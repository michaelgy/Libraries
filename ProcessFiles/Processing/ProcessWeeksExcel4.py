...
class main(ProcessFileWF):
    ...
    def process_sheet(self, input_sheet:"Worksheet object", output_sheet:"Worksheet object", output_startrow:int, output_startrow_micro:int):
        ...
        if rd:
            ...
            fila_inicio_micro, columna_inicio_micro = self.cell(input_sheet, "MICROPARADAS \(DMQ\)")[0] #Fila y Columna de input_sheet donde comienzan los datos de microparadas
            fila_inicio_micro += 2
...
if __name__ == "__main__":
    """Testing"""
    output_file="Z:\\Informacion de estudiante en practica\\Archivos para indicadores de mantto\\MTTO CORRECTIVO - DMS\\Anual\\2020S30-53.xlsm"
    input_file="Z:\\Informacion de estudiante en practica\\Archivos para indicadores de mantto\\MTTO CORRECTIVO - DMS\\2020\\SEMANAS\\Semana 30\\Mtto Correctivo Semanal 30-macro.xlsm"
